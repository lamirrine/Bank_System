...
public class TransferView extends JPanel {
    ...
    private JPanel createHeader() {
        ...
        JLabel titleLabel = new JLabel("Transferência");
    ...
    private JScrollPane createMainContent() {
        ...
        // Transfer section
        content.add(createTransferSection(), "growx");
    ...
    private JPanel createTransferSection() {
        JPanel panel = createCard();
        panel.setLayout(new MigLayout("wrap, fill, insets 25", "[grow]", "[]15[]15[]15[]"));

        JLabel titleLabel = new JLabel("Realizar Transferência");
        ...
        // Destination account
        JPanel destinationAccountPanel = new JPanel(new MigLayout("wrap, fill, insets 0", "[grow]", "[]10[]5[]"));
        destinationAccountPanel.setOpaque(false);

        JLabel destinationAccountLabel = new JLabel("Conta de Destino:");
        destinationAccountLabel.setFont(new Font("Segoe UI", Font.BOLD, 14));
        destinationAccountLabel.setForeground(new Color(15, 23, 42));

        JLabel destinationHintLabel = new JLabel("Digite o número da conta destino");
        destinationHintLabel.setFont(new Font("Segoe UI", Font.PLAIN, 12));
        destinationHintLabel.setForeground(new Color(107, 114, 128));

        destinationAccountField = new JTextField();
        destinationAccountField.setFont(new Font("Segoe UI", Font.PLAIN, 16));
        destinationAccountField.setBorder(BorderFactory.createCompoundBorder(
                BorderFactory.createLineBorder(new Color(203, 213, 225)),
                BorderFactory.createEmptyBorder(10, 10, 10, 10)
        ));

        destinationAccountPanel.add(destinationAccountLabel, "growx, wrap");
        destinationAccountPanel.add(destinationHintLabel, "growx, wrap");
        destinationAccountPanel.add(destinationAccountField, "growx, h 45!");

        // Amount input
        JPanel amountPanel = new JPanel(new MigLayout("wrap, fill, insets 0", "[grow]", "[]10[]5[]"));
        amountPanel.setOpaque(false);

        JLabel amountTitleLabel = new JLabel("Valor da Transferência");
        amountTitleLabel.setFont(new Font("Segoe UI", Font.BOLD, 14));
        amountTitleLabel.setForeground(new Color(15, 23, 42));

        JLabel maxAmountLabel = new JLabel("Máximo: MZN 10.000,00 por transação");
    ...
    private JPanel createQuickAmountsSection() {
        ...
        String[] amounts = {"MZN 500", "MZN 1.000", "MZN 2.500", "MZN 5.000"};
    ...
    private JPanel createDailyLimitsSection() {
        ...
        JLabel titleLabel = new JLabel("Limites de Transferência");
        titleLabel.setFont(new Font("Segoe UI", Font.BOLD, 20));
        titleLabel.setForeground(new Color(15, 23, 42));
        ...
        // Daily Limit
        JPanel dailyLimitPanel = createLimitCard("Limite por Transação", "Máximo: MZN 10.000,00");
        dailyLimitLabel = new JLabel("MZN 10.000,00");
        ...
        // Used Today
        JPanel usedTodayPanel = createLimitCard("Transferido Hoje", "Valor transferido hoje");
        usedTodayLabel = new JLabel("MZN 1.500,00");
        usedTodayLabel.setFont(new Font("Segoe UI", Font.BOLD, 16));
        usedTodayLabel.setForeground(new Color(245, 158, 11));
        usedTodayPanel.add(usedTodayLabel, "growx, wrap");

        // Remaining
        JPanel remainingPanel = createLimitCard("Restante Disponível", "Pode transferir hoje");
        remainingLabel = new JLabel("MZN 8.500,00");
    ...
    // Classe para limitar o número de caracteres no PIN
    ...
    public JTextField getDestinationAccountField() { return destinationAccountField; }
